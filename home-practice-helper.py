...
#add monthly practice by week
 bot_response_week_1 = ["Downward dog for 20 minutes", "Forward bend sequence ending in parchimotanasana with these poses we hal the nervous system.", "1 hour long savasana, nothing better for the mind."] 
